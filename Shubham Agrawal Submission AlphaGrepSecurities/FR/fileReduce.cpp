 ...
 * Details: FileReduce: 
 * 1. First collected all the rows within a tree into packets
 * 2. Then created subfiles using these packets:
 *  a. Greedy algorithm for packet selection for subfiles
 *  b. Sort packets according to number of rows
 *  c. Pick maximum sized packet and add packets greedily
 */
#include <iostream>
#include <string>
#include <stdlib.h>
